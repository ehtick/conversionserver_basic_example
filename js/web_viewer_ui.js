            ...
            c.prototype._setSection = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(c) {
                        ...
                        return null ===
                            d ? [2] : [2, this._cuttingSectionsMgr.addPlane(a, d, this._showReferenceGeometry ? g : null)]
                    })
                })
            };
    ...
    (function(m) {
        ...
        var c = function() {
            ...
            a.prototype.onResizeElement = function(b, a) {
                ...
                var f = $(a).outerHeight(),
                    h = $(a).height();
                void 0 !== d && void 0 !== k && void 0 !== e && void 0 !== c && void 0 !== f && void 0 !== h && (this._treePropertyContainer.style.height = b - d - 2 * this._browserWindowMargin + "px", d = b - d - k - e - c + f - 2 * this._browserWindowMargin - (f - h), 0 > d && (d = 0), this._browserWindow.style.height = b - 2 * this._browserWindowMargin + "px", a.style.height = d + "px", this._refreshBrowserScroll())
            };
    ...
    (function(m) {
        ...
        var c = function() {
            function a(b, a) {
                ...
                b && (b = document.createElement("div"), b.id = "modelBrowserWindow", a.appendChild(b), this._modelBrowser = new m.ModelBrowser(b.id, a.id, this._viewer, this._isolateZoomHelper, this._colorPicker));
                ...
                this._viewer.setCallbacks({
                    ...
                    modelSwitched: function(b) {
                        b && (d._modelType =
                            h.Generic, d._configureUi(d._modelType))
                    },
                    ...
                    return __generator(this, function(g) {
                        switch (g.label) {
                            ...
                            case 7:
                                return [2];
                            case 8:
                                return this._position = null, this.showElements(a,true), [2] //3DSANDBOX CHANGES
                        }
                    })
                })
            };
                        ...
                        return __generator(this, function(d) {
                            switch (d.label) {
                                ...
                                case 1:
                                    m = d.sent();
                                    p = [];
                                    if (null !== m && (p = Object.keys(m), 0 < p.length))
                                        for (e = document.createElement("table"), e.id = "propertyTable", e.appendChild(this._createRow("Property",
                                                "Value", "headerRow")), e.appendChild(this._createRow("Name", null !== l ? l : "unnamed")), n = 0, q = p; n < q.length; n++) t = q[n], u = f(t), v = f(m[t]), e.appendChild(this._createRow(u, v));
                                    r = a.getNodeUserDataIndices(c);
                                    if (0 < r.length)
                                        for (h = document.createElement("table"), h.id = "propertyTable", h.appendChild(this._createRow("User Data Index", "User Data Size", "headerRow")), x = 0, z = r; x < z.length; x++) y = z[x], B = a.getNodeUserData(c, y), u = "number" === typeof y ? "0x" + y.toString(16).toUpperCase() : "0x" + y, v = "" + B.length, h.appendChild(this._createRow(u,
                                            v));
