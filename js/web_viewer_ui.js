var __extends = this && this.__extends || function() {
    ...
    return function(f, m) {
        ...
        e(f, m);
        f.prototype = null === m ? Object.create(m) : (h.prototype = m.prototype,
        new h)
    }
...
, __generator = this && this.__generator || function(e, f) {
    ...
    function h(g) {
        ...
        for (; c; )
            try {
                if (a = 1,
                b && (d = g[0] & 2 ? b["return"] : g[0] ? b["throw"] || ((d = b["return"]) && d.call(b),
                0) : b.next) && !(d = d.call(b, g[1])).done)
                    return d;
                if (b = 0,
                d)
                    g = [g[0] & 2, d.value];
                ...
                default:
                    if (!(d = c.trys,
                    d = 0 < d.length && d[d.length - 1]) && (6 === g[0] || 2 === g[0])) {
                        c = 0;
                        continue
                    }
                    if (3 === g[0] && (!d || g[1] > d[0] && g[1] < d[3]))
                        c.label = g[1];
                    else if (6 === g[0] && c.label < d[1])
                        c.label = d[1],
                        d = g;
...
(function(e) {
    var f = function(e) {
        ...
        ;
        c.prototype.getTextBoxAnchor = function() {
    ...
    var m = function() {
        ...
        e.prototype._onPulseChange = function(c, a) {
            ...
            void 0 !== c && (c.setShowAsColor(a.checked),
            a.checked ? this._pulseManager.add(c.getNodeId(), this._pulseManager.getDefaultColor1(), this._pulseManager.getDefaultColor2(), this._pulseManager.getDefaultPulseTime()) : (this._pulseManager.deletePulse(c.getNodeId()),
            this._viewer.redraw()))
        }
        ;
        e.prototype._renameAnnotation = function(c) {
            ...
            if (void 0 !== a) {
                ...
                c = document.getElementById(c + "-name"),
                null !== c && (c.innerText = b))
            }
        }
        ;
        e.prototype._deleteAnnotation = function(c) {
            ...
            var a = this._annotationMap[c];
            void 0 !== a && (this._pulseManager.deletePulse(a.getNodeId()),
            delete this._annotationMap[c]);
            c = document.getElementById(c);
            null !== c && null !== c.parentElement && c.parentElement.removeChild(c)
        }
        ;
        return e
    }();
    ...
    m = function() {
        ...
        e.prototype.onMouseDown = function(c) {
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(e) {
                    ...
                    case 1:
                        a = e.sent();
                        if (null !== a && 0 !== a.overlayIndex())
                            return [2];
                        b = c.getPosition();
                        this._selectAnnotation(b) ? c.setHandled(!0) : null !== a && a.isNodeEntitySelection() && (d = a.getNodeId(),
                        g = a.getPosition(),
                        l = new f(this._viewer,d,g,this._viewer.model.getNodeName(d) + " Connector"),
                        k = this._viewer.markupManager.registerMarkup(l),
                        this._annotationRegistry.addAnnotation(k, l),
                        this._startDraggingAnnotation(l, b),
                        c.setHandled(!0));
                        return [2]
                    }
                })
            ...
            return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(k) {
                    ...
                    case 2:
                        g = k.sent(),
                        l = g.getNodeId(),
                        l !== this._previousNodeId && (null != this._previousNodeId && this._viewer.model.setNodesHighlighted([this._previousNodeId], !1),
                        null != l && this._viewer.model.setNodesHighlighted([l], !0)),
                        this._previousNodeId = l,
                        k.label = 3;
                    case 3:
                        return [2]
                    }
        ...
        ;
        e.prototype._startDraggingAnnotation = function(c, a) {
        ...
        e.prototype._selectAnnotation = function(c) {
            ...
            return a ? (this._activeMarkup = a,
            this._previousAnchorPlaneDragPoint = this._getDragPointOnAnchorPlane(c),
            !0) : !1
        }
        ;
        ...
        (function(m) {
            ...
            var c = function() {
                ...
                a.prototype._onNewModel = function() {
                    this._viewer.sheetManager.isDrawingSheetActive() && (this._contextItemMap.reset.hide(),
                    void 0 !== this._contextItemMap.meshlevel0 && this._contextItemMap.meshlevel0.hide(),
                    void 0 !== this._contextItemMap.meshlevel1 && this._contextItemMap.meshlevel1.hide(),
                    void 0 !== this._contextItemMap.meshlevel2 && this._contextItemMap.meshlevel2.hide(),
                    $(".contextmenu-separator-3").hide())
                }
                ;
                a.prototype._isMenuItemEnabled = function() {
                    if (null !== this._activeLayerName || null !== this._activeType || null !== this._activeItemId && !this._viewer.noteTextManager.checkPinInstance(this._activeItemId))
                        return !0;
                    for (var b = 0, d = this._viewer.selectionManager.getResults(); b < d.length; b++)
                        if (1 !== d[b].overlayIndex())
                            return !0;
                    return !1
                }
                ;
                ...
                a.prototype._updateMenuItems = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(g) {
                            switch (g.label) {
                            case 0:
                                return b = this.getContextItemIds(!0, !0, !1),
                                d = this._isMenuItemEnabled(),
                                a = this._isMenuItemVisible(),
                                this._contextItemMap.visibility.setText(a ? "Hide" : "Show"),
                                this._contextItemMap.visibility.setEnabled(d),
                                this._contextItemMap.isolate.setEnabled(d),
                                this._contextItemMap.zoom.setEnabled(d),
                                this._contextItemMap.transparent.setEnabled(d),
                                k = (c = this._contextItemMap.setColor).setText,
                                [4, this._isColorSet(b)];
                            case 1:
                                return k.apply(c, [(g.sent() ? "Uns" : "S") + "et Color"]),
                                (h = this._viewer.operatorManager.getOperator(e.OperatorId.Handle)) && h.isEnabled && d ? (f = 0 < b.length && h.isEnabled(),
                                this._contextItemMap.handles.setEnabled(f)) : this._contextItemMap.handles.setEnabled(!1),
                                void 0 !== this._contextItemMap.meshlevel0 && this._contextItemMap.meshlevel0.setEnabled(d),
                                void 0 !== this._contextItemMap.meshlevel1 && this._contextItemMap.meshlevel1.setEnabled(d),
                                void 0 !== this._contextItemMap.meshlevel2 && this._contextItemMap.meshlevel2.setEnabled(d),
                                [2]
                            }
                        })
                    })
                ...
                a.prototype.showElements = function(b) {
                    ...
                    var d = this._viewer.view.getCanvasSize()
                      ...
                      , c = a.outerWidth()
                      , k = a.outerHeight();
                    void 0 !== k && void 0 !== c && (k > d.y && a.addClass("small"),
                    a = b.y,
                    b = b.x,
                    a + k > d.y && (a = d.y - k - 1),
                    b + c > d.x && (b = d.x - c - 1),
                ...
                a.prototype.action = function(b) {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(a) {
                            switch (a.label) {
                            case 0:
                                return d = this._contextItemMap[b],
                                void 0 === d ? [3, 2] : [4, d.action()];
                            case 1:
                                a.sent(),
                                a.label = 2;
                            case 2:
                ...
                a.prototype._doMenuClick = function(b) {
                    b = $(b.target);
                    b.hasClass("disabled") || (b = b.attr("id"),
                    void 0 !== b && this.action(b),
                    this.hide())
                }
                ;
                    ...
                    this.appendItem("transparent", "Transparent", function() {
                        return __awaiter(b, void 0, void 0, function() {
                            ...
                            return __generator(this, function(g) {
                                ...
                                case 1:
                                    a = g.sent()[0],
                                    null === a || 1 === a ? d.setNodesOpacity(b, .5) : d.resetNodesOpacity(b),
                                    g.label = 2;
                                case 2:
                                    return [2]
                                }
                    ...
                    this.appendItem("setColor", "Set Color", function() {
                        return __awaiter(b, void 0, void 0, function() {
                            ...
                            return __generator(this, function(a) {
                                ...
                                case 0:
                                    return b = this.getContextItemIds(!0, !0, !1),
                                    0 < b.length ? [4, this._isColorSet(b)] : [3, 2];
                                case 1:
                                    a.sent() ? this._viewer.model.unsetNodesFaceColor(b) : (d = this._colorPicker.getColor().copy(),
                                    this._viewer.model.setNodesFaceColor(b, d)),
                                    a.label = 2;
                                case 2:
                                    return [2]
                                }
                    ...
                    this.appendItem("reset", "Reset Model", function() {
                        return __awaiter(b, void 0, void 0, function() {
                            ...
                            return __generator(this, function(g) {
                                switch (g.label) {
                                case 0:
                                    return b = a.getOperator(e.OperatorId.Handle),
                                    [4, b.removeHandles()];
                                case 1:
                                    return g.sent(),
                                    [4, d.reset()];
                                case 2:
                                    return g.sent(),
                                    d.unsetNodesFaceColor([this._viewer.model.getAbsoluteRootNode()]),
                                    [2]
                                }
                            })
                        })
                    ...
                    if (this._viewer.getCreationParameters().hasOwnProperty("model")) {
                        ...
                        for (var k = function(a) {
                            h.appendItem("meshlevel" + a, "Mesh Level " + a, function() {
                                return __awaiter(b, void 0, void 0, function() {
                                    return __generator(this, function(g) {
                                        b._isMenuItemExecutable() && d.setMeshLevel(b.getContextItemIds(!0, !0), a);
                                        return [2]
                                    })
                                })
                            })
                ...
                a.prototype.getContextItemIds = function(b, d, a) {
                    ...
                    if (null !== this._activeLayerName && (c = this._viewer.model.getLayerIdsFromName(this._activeLayerName),
                    null !== c))
                        for (b = 0; b < c.length; b++)
                            if (n = this._viewer.model.getNodesFromLayer(c[b]),
                            null !== n)
                    ...
                    null !== this._activeType && (n = this._viewer.model.getNodesByGenericType(this._activeType),
                    null !== n && n.forEach(function(b) {
                        var d = e.Selection.SelectionItem.create(b);
                        g.contains(d) || f.push(b)
                    }));
                    null !== this._activeItemId && (t = e.Selection.SelectionItem.create(this._activeItemId),
                    c = null !== g.containsParent(t),
                    b = -1 !== f.indexOf(this._activeItemId),
                    !d || !a && (a || this._activeItemId === h || 0 !== f.length && (b || c)) || f.push(this._activeItemId));
                    return f
                }
                ;
                        ...
                        for (var d = 0; d < b.length; d++) {
                            ...
                            if (null !== a)
                                for (var c = 0; c < a.length; c++)
                                    if (this._viewer.model.getNodeVisibility(a[c]))
                                        return !0
                        }
                    return !1
                }
                ...
                a.prototype._isTypeVisible = function(b) {
                    var d = this
                      , a = !1;
                    null !== b && (b = this._viewer.model.getNodesByGenericType(b),
                    null !== b && b.forEach(function(b) {
            ...
            (function(f) {
                var c = function() {
                    ...
                    a.prototype.get = function(b) {
                        ...
                        void 0 === d && (d = new e.Info,
                        this._planeInfoMap.set(b, d));
                        return d
                    }
                    ;
                    ...
                    Object.defineProperty(a.prototype, "X", {
                        get: function() {
                            if (!this._cuttingManager)
                                throw Error("Ui.CuttingSectionManager as not been initialized");
                    ...
                    a.prototype.getPlaneIndex = function(b, d) {
                        if (this._useIndividualCuttingSections) {
                            ...
                            for (var c = a.getCount(), k = 0; k < c; k++) {
                                var e = a.getPlane(k);
                                if (e && (e.normal.x && 0 === b || e.normal.y && 1 === b || e.normal.z && 2 === b || 3 === b && d && e.normal.equals(d)))
                                    return k
                            }
                        }
                        return -1
                    ...
                    a.prototype.addPlane = function(b, d, a) {
                        return __awaiter(this, void 0, void 0, function() {
                            return __generator(this, function(g) {
                                switch (g.label) {
                                case 0:
                                    return [4, this.get(this.getCuttingSectionIndex(b)).addPlane(d, a)];
                                case 1:
                                    return g.sent(),
                                    [2]
                                }
                    ...
                    a.prototype.init = function(b) {
                        return __awaiter(this, void 0, void 0, function() {
                            ...
                            return __generator(this, function(a) {
                                ...
                                case 0:
                                    return d = this,
                                    [4, b.model.getModelBounding(!0, !1)];
                                case 1:
                                    return d._modelBounding = a.sent(),
                                    [2]
                                }
                            })
                        })
                    ...
                    a.prototype.update = function(b) {
                        return __awaiter(this, void 0, void 0, function() {
                            ...
                            return __generator(this, function(g) {
                                ...
                                case 1:
                                    return d = g.sent(),
                                    a = this._modelBounding.min.equalsWithTolerance(d.min, .01),
                                    c = this._modelBounding.max.equalsWithTolerance(d.max, .01),
                                    a && c ? [2, !1] : (this._modelBounding = d,
                                    [2, !0])
                                }
                            })
                        })
            ...
            (function(f) {
                function c(b, d) {
                    var a = this
                      , l = d.payload
                      , k = function(b) {
                        return "update triggered" === b.name
                    };
                    switch (d.name) {
                    case "init":
                    ...
                    case "update":
                        if ("not initialized" === b.name)
                            throw Error("CuttingPlane.Controller.StateMachine has not been initialized");
                        if (k(b))
                            break;
                        ...
                        return __generator(this, function(l) {
                            ...
                            case 0:
                                ...
                                for (c = 0; c < a.length; ++c)
                                    k = a[c],
                                    null !== k && (e = f.ControllerUtils.PlaneInfoManager.getPlaneSectionIndex(k),
                                    h = this._planeInfoMgr.get(e),
                                    0 === h.status && (h.status = f.ControllerUtils.PlaneInfoManager.getCuttingStatus(e, k),
                                    h.plane = k,
                                    h.referenceGeometry = b[c]));
                                this._viewer.pauseRendering();
                                return [4, this._cuttingSectionsMgr.clearAll()];
                            case 1:
                                return l.sent(),
                                [4, this._restorePlanes()];
                            case 2:
                                return l.sent(),
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(c) {
                            ...
                            case 2:
                                return c.sent(),
                                b.status = 1,
                                [4, this.setCuttingPlaneVisibility(!0, a)];
                            case 3:
                                c.sent(),
                                c.label = 4;
                            case 4:
                            ...
                            case 8:
                                return b.status = 2,
                                [4, this.setCuttingPlaneInverted(a)];
                            case 9:
                                return c.sent(),
                                [3, 12];
                            case 10:
                                return b.status = 0,
                                [4, this.setCuttingPlaneVisibility(!1, a)];
                            case 11:
                                return c.sent(),
                                [3, 12];
                            case 12:
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(l) {
                            ...
                            case 0:
                                ...
                                if (void 0 === g)
                                    return this._pendingFuncs.visibility = function() {
                                ...
                                null === c.plane && (c.plane = this._generateCuttingPlane(b),
                                c.referenceGeometry = this._generateReferenceGeometry(b));
                            ...
                            case 4:
                                ...
                                e = this._cuttingSectionsMgr.isActive(b),
                                0 < k && !e ? [4, this._cuttingSectionsMgr.activateAll()] : [3, 6];
                            case 5:
                                return l.sent(),
                                [3, 8];
                            case 6:
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(l) {
                            ...
                            case 0:
                                ...
                                if (void 0 === b)
                                    return this._pendingFuncs.inverted = function() {
                ...
                c.prototype.refreshPlaneGeometry = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        return __generator(this, function(a) {
                            switch (a.label) {
                            case 0:
                                return this._storePlanes(),
                                [4, this._cuttingSectionsMgr.clearAll()];
                            case 1:
                                return a.sent(),
                                [4, this._restorePlanes()];
                            case 2:
                ...
                c.prototype._restorePlane = function(a) {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(d) {
                            ...
                            case 0:
                                b = this._planeInfoMgr.get(a);
                                if (void 0 === b || null === b.plane || 0 === b.status)
                                    return [3, 2];
                                if (null === b.referenceGeometry || b.updateReferenceGeometry)
                                    b.referenceGeometry = this._generateReferenceGeometry(a);
                ...
                c.prototype._restorePlanes = function(a) {
                    return __awaiter(this, void 0, void 0, function() {
                        return __generator(this, function(b) {
                            ...
                            case 1:
                                return b.sent(),
                                [4, this._cuttingSectionsMgr.activateAll(a)];
                            case 2:
                                return b.sent(),
                                [2]
                            }
                ...
                c.prototype._generateCuttingPlane = function(a) {
                    ...
                    case 3:
                        if (this._faceSelectionMgr.isSet)
                            b.setFromPointAndNormal(this._faceSelectionMgr.position, this._faceSelectionMgr.normal);
                        else
                            return null
                    }
                    return b
...
(function(e) {
    ...
    var m = function() {
        ...
        h.prototype.showAll = function() {
            ...
            a = [];
            c.isDrawing() ? (c = this._viewer.sheetManager.get3DNodes(),
            a.push(this.isolateNodes(c))) : a.push(c.resetNodesVisibility());
            null !== this._camera && (this._viewer.view.setCamera(this._camera, e.DefaultTransitionDuration),
            this._camera = null);
            this._isolateStatus = !1;
    ...
    var f = function() {
      ...
      , m = function() {
        ...
        e.prototype.deletePulse = function(c) {
            this._pulseInfoMap.hasOwnProperty(c.toString()) && (this._viewer.model.unsetNodesFaceColor([c]),
            delete this._pulseInfoMap[c])
        }
        ;
        ...
        e.prototype.update = function() {
            ...
            for (var c = Date.now(), a = c - this._previousTime, b = {}, d = !1, g = 0, l = Object.keys(this._pulseInfoMap); g < l.length; g++) {
                ...
                b[k.id] = e;
                k.progress >= k.duration && (k.direction = 0 === k.direction ? 1 : 0,
                k.progress = 0)
            }
            d && (this._viewer.model.setNodesColors(b),
            this._viewer.redraw());
            ...
            c.prototype.doContext = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(c) {
                        switch (c.label) {
                        case 0:
                            return b = new e.PickConfig(e.SelectionMask.All),
                            [4, this._viewer.view.pickFromPoint(a, b)];
                        case 1:
                            return d = c.sent(),
                            d.isNodeSelection() && (g = this._viewer.model.getNodeType(d.getNodeId())),
                            void 0 !== g && g !== e.NodeType.Pmi && g !== e.NodeType.PmiBody && 1 !== d.overlayIndex() ? [3, 3] : [4, this.setActiveItemId(null)];
                        case 2:
                            return c.sent(),
                            [3, 5];
                        case 3:
                        ...
                        case 4:
                            ...
                            c.label = 5;
                        case 5:
                            return this._position = d.getPosition(),
                            this.showElements(a),
                            [2]
                        }
                    })
                ...
                return __awaiter(this, void 0, void 0, function() {
                    return __generator(this, function(b) {
                        ...
                        case 1:
                            ...
                            [3, 3];
                        case 2:
                            f.prototype._onContextLayerClick.call(this, a),
                            b.label = 3;
                        case 3:
                            return [2]
                        }
    ...
    (function(f) {
        var m = function() {
            function h(c, a, b) {
                ...
                this._viewer.setCallbacks({
                    selectionArray: function(b) {
                        0 < b.length ? (b = b[b.length - 1].getSelection(),
                        null !== b && b.isFaceSelection() && ($(d._cuttingPlaneFaceSelector).removeClass(d._disabledClass),
                        $("#view-face").removeClass(d._disabledClass))) : ($(d._cuttingPlaneFaceSelector).addClass(d._disabledClass),
                        $("#view-face").addClass(d._disabledClass))
                    },
            ...
            h.prototype.init = function() {
                ...
                $(".hoops-tool").on("click", function(a) {
                    a.preventDefault();
                ...
                $(".tool-icon, .submenu-icon").on("mouseenter", function(a) {
                    c._mouseEnterItem(a)
                }),
            ...
            h.prototype.enableSubmenuItem = function(c) {
                var a = this;
                "string" === typeof c ? $("#submenus .toolbar-" + c).removeClass(this._disabledClass) : "object" === typeof c && $.each(c, function(b, d) {
            ...
            h.prototype._processButtonClick = function(c) {
                if (null !== this._activeSubmenu)
                    ...
                    a.hasClass("toolbar-radio") ? a.hasClass("active-tool") ? this._showSubmenu(c) : ($(this._toolbarSelector).find(".active-tool").removeClass("active-tool"),
                    a.addClass("active-tool"),
                    this._performNullaryAction(a.data("operatorclass"))) : a.hasClass("toolbar-menu") ? this._showSubmenu(c) : a.hasClass("toolbar-menu-toggle") ? this._toggleMenuTool(a) : this._performNullaryAction(a.data("operatorclass"))
                }
            }
            ;
            h.prototype._toggleMenuTool = function(c) {
                ...
                a.is(":visible") ? (a.hide(),
                this._performBooleanAction(c.data("operatorclass"), !1)) : (this._alignMenuToTool(a, c),
                this._performBooleanAction(c.data("operatorclass"), !0))
            }
            ;
            ...
            h.prototype._showSubmenu = function(c) {
                ...
                var a = c.data("submenu");
                a && (a = $(this._toolbarSelector + " #submenus #" + a),
                a.hasClass(this._disabledClass) || (this._alignMenuToTool(a, c),
                this._activeSubmenu = a[0],
                this._startModal(),
            ...
            h.prototype._hideActiveSubmenu = function() {
                ...
                null !== this._activeSubmenu && ($(this._activeSubmenu).hide(),
                $(this._toolbarSelector).find(".toolbar-tools").css({
                    opacity: 1
                }));
                this._activeSubmenu = null
            ...
            h.prototype._activateSubmenuItem = function(c) {
                ...
                if ("string" !== typeof b)
                    throw new e.CommunicatorError("Invalid submenuItem.");
                a = $("#" + a.data("button"));
                var d = a.find(".tool-icon");
                d.length && (d.removeClass(a.data("operatorclass").toString()),
                d.addClass(b),
                a.data("operatorclass", b),
                c = c.attr("title"),
            ...
            h.prototype._submenuIconClick = function(c) {
                c = $(c);
                c.hasClass(this._disabledClass) || (c = this._activateSubmenuItem(c),
                this._hideActiveSubmenu(),
                this._performNullaryAction(c))
            }
            ;
            ...
            h.prototype.setSubmenuEnabled = function(c, a) {
                ...
                a ? (c.find(".smarrow").show(),
                b.removeClass(this._disabledClass)) : (c.find(".smarrow").hide(),
                b.addClass(this._disabledClass))
            }
            ;
            ...
            h.prototype._performBooleanAction = function(c, a) {
                (c = this._actionsBoolean.get(c)) && c(a)
            }
            ;
            ...
            h.prototype._initSnapshot = function() {
                $("#snapshot-dialog-cancel-button").button().on("click", function() {
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(w) {
                        ...
                        case 1:
                            ...
                            n = (l - d) / 2,
                            q = $("#snapshot-dialog"),
                            $("#snapshot-dialog-image").attr("src", m.src).attr("width", f).attr("height", b + 40),
                            q.css({
                                top: "45px",
                                left: n + "px"
                            }),
            ...
            h.prototype._initActions = function() {
                ...
                this._actionsNullary.set("toolbar-home", function() {
                    ...
                    if (!c._viewer.sheetManager.isDrawingSheetActive()) {
                        ...
                        var d = b.getOperator(e.OperatorId.Handle);
                ...
                this._actionsNullary.set("toolbar-measure-distance", function() {
                    b.set(e.OperatorId.MeasureFaceFaceDistance, 1)
                });
                ...
                this._actionsNullary.set("toolbar-back", function() {
                    return __awaiter(c, void 0, void 0, function() {
                        return __generator(this, function(b) {
                            switch (b.label) {
                            case 0:
                                return [4, a.setViewOrientation(e.ViewOrientation.Back, this._viewOrientationDuration)];
                            case 1:
                                return b.sent(),
                                [2]
                            }
            ...
            ;
            h.prototype._explosionButtonClick = function(c) {
            ...
            ;
            h.prototype._cuttingPlaneButtonClick = function(c) {
                var a = this;
            ...
            h.prototype._updateCuttingPlaneIcons = function() {
                ...
                0 < b ? (c ? $(this._cuttingPlaneVisibilitySelector).removeClass(this._selectedClass) : $(this._cuttingPlaneVisibilitySelector).addClass(this._selectedClass),
                $(this._cuttingPlaneVisibilitySelector).removeClass(this._disabledClass),
                $(this._cuttingPlaneResetSelector).removeClass(this._disabledClass)) : ($(this._cuttingPlaneVisibilitySelector).addClass(this._disabledClass),
    ...
    (function(f) {
        var m = function() {
            ...
            h.prototype._updateColor = function() {
                this._color.assign(f.colorFromRgbString(f.getValueAsString("#" + this._colorPickerInputId)));
        ...
        (function(m) {
            ...
            var c = function() {
                function a(b, d, a, c, k) {
                    ...
                    this._elementIdMap.set(h.Model, "modelTree");
                    ...
                    this._contextMenu = new m.ModelBrowserContextMenu(this._containerId,this._viewer,this._treeMap,this._isolateZoomHelper,this._colorPicker);
                    this._initEvents();
                ...
                a.prototype._setTreeVisibility = function(b, d) {
                    ...
                    a = $("#" + a + "Tab");
                    d ? (c.show(),
                    a.addClass("browser-tab-selected"),
                    b instanceof f.BCFTree ? (this._setPropertyWindowVisibility(!1),
                    this._setRelationshipsWindowVisibility(!1)) : (this._setPropertyWindowVisibility(!0),
                    this._updateRelationshipsTreeVisibility())) : (c.hide(),
                    a && a.removeClass("browser-tab-selected"))
                }
                ;
                ...
                a.prototype._addTree = function(b, d) {
                    ...
                    var c;
                    d === h.Model ? c = new f.ModelTree(this._viewer,b,a) : d === h.CadView ? c = new f.CadViewTree(this._viewer,b,a) : d === h.Sheets ? c = new f.SheetsTree(this._viewer,b,a) : d === h.Configurations ? c = new f.ConfigurationsTree(this._viewer,b,a) : d === h.Layers ? c = new f.LayersTree(this._viewer,b,a) : d === h.Filters ? c = new f.FiltersTree(this._viewer,b,a) : d === h.Types ? c = new f.TypesTree(this._viewer,b,a) : d === h.BCF ? c = new f.BCFTree(this._viewer,b,a) : d === h.Relationships ? c = new f.RelationshipsTree(this._viewer,b,a) : e.Util.TypeAssertNever(d);
                ...
                a.prototype._createBrowserWindow = function() {
                    ...
                    var d = $(window).width();
                    void 0 !== d && (b.style.width = Math.max(d / 4, 400) + "px");
                ...
                a.prototype.onResize = function(b) {
                    ...
                    void 0 !== d && void 0 !== a && void 0 !== c && (this._treePropertyContainer.style.height = b - d - 2 * this._browserWindowMargin + "px",
                    d = b - d - a - c - 2 * this._browserWindowMargin,
                    this._browserWindow.style.height = b - 2 * this._browserWindowMargin + "px",
                    this._content.style.height = d + "px",
                    this._refreshBrowserScroll())
                }
                ;
                a.prototype.onResizeElement = function(b, a) {
                    var d = $(this._header).outerHeight()
                      , c = $(this._content).outerHeight()
                      , k = $(this._propertyWindow).outerHeight()
                      , e = $(this._relationshipsWindow).outerHeight();
                    $(a).hasClass("hidden") && (a = this._content);
                    var f = $(a).outerHeight()
                      , h = $(a).height();
                    void 0 !== d && void 0 !== k && void 0 !== e && void 0 !== c && void 0 !== f && void 0 !== h && (this._treePropertyContainer.style.height = b - d - 2 * this._browserWindowMargin + "px",
                    d = b - d - k - e - c + f - 2 * this._browserWindowMargin - (f - h),
                    0 > d && (d = 0),
                    this._browserWindow.style.height = b - 2 * this._browserWindowMargin + "px",
                    a.style.height = d + "px",
                    this._refreshBrowserScroll())
        ...
        (function(m) {
            ...
            var c = function() {
                function a(b, a) {
                    ...
                    if (void 0 === this._params.containerId)
                        throw new e.ParseError("Must supply 'containerId'.");
                    ...
                    this._cuttingPlaneController = new f.CuttingPlane.Controller(this._viewer);
                    this._isolateZoomHelper = new e.IsolateZoomHelper(this._viewer);
                    c && (this._toolbar = new f.Toolbar(this._viewer,this._cuttingPlaneController,a),
                    this._toolbar.init());
                    ...
                    b.id = "modelBrowserWindow",
                    a.appendChild(b),
                    this._modelBrowser = new m.ModelBrowser(b.id,a.id,this._viewer,this._isolateZoomHelper,this._colorPicker));
                    ...
                    this._viewer.setCallbacks({
                        ...
                        XHRonloadend: function(b, a, d) {
                            404 === a && (b = new f.UiDialog("content"),
                            b.setTitle("404 Error"),
                ...
                a.prototype._configureUi = function(b) {
                    if (this._uiModelType !== b) {
                        ...
                        b === h.Drawing ? (a.disable(),
                        c.disable(),
                        this._viewer.view.setDrawMode(e.DrawMode.WireframeOnShaded)) : (a.enable(),
                        b === h.Bim ? this._viewer.view.setBackfacesVisible(!0) : c.enable());
                ...
                a.prototype._configureToolbar = function(b) {
                    null !== this._toolbar && (b === h.Drawing ? ($("#cuttingplane-button").hide(),
                    ...
                    $("#edgeface-submenu").hide()) : ($("#cuttingplane-button").show(),
                    $("#explode-button").show(),
                    $("#view-button").show(),
                    $("#camera-button").show(),
...
(function(e) {
    (function(f) {
        (function(m) {
            var h = function(c) {
                function a(b, a, g, l, e) {
                    b = c.call(this, "modelbrowser", b, a, l, e) || this;
                    b._treeMap = g;
                    b._initEvents();
                    return b
                }
                ...
                a.prototype._initEvents = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(d) {
                            ...
                            case 1:
                                return d.sent(),
                                [4, this._registerContextMenuCallback(m.Tree.Layers)];
                            case 2:
                                return d.sent(),
                                [4, this._registerContextMenuCallback(m.Tree.Types)];
                            case 3:
                                return d.sent(),
                                this._viewer.getStreamingMode() === e.StreamingMode.OnDemand && (b = function() {
                                    return __awaiter(a, void 0, void 0, function() {
                                        return __generator(this, function(b) {
                                            switch (b.label) {
                                            case 0:
                                ...
                                ,
                                this.appendSeparator(),
                                this.appendItem("request", "Request", b)),
                                [2]
                            }
                        })
                    })
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(g) {
                            ...
                            case 4:
                                ...
                                [3, 8];
                            case 5:
                                return e = parseInt(d[1], 10),
                                [4, this.setActiveItemId(e)];
                            case 6:
                                return g.sent(),
                                [3, 8];
                            case 7:
        ...
        (function(e) {
            ...
            var c = function() {
                ...
                a.prototype._onPartSelection = function(b) {
                    return __awaiter(this, void 0, void 0, function() {
                        var a, c, l, e, h, m, p, n, q, t, u, v, r, x, z, y, B;
                        return __generator(this, function(d) {
                            switch (d.label) {
                            case 0:
                            ...
                            case 1:
                                m = d.sent();
                                p = [];
                                if (null !== m && (p = Object.keys(m),
                                0 < p.length))
                                    for (e = document.createElement("table"),
                                    e.id = "propertyTable",
                                    e.appendChild(this._createRow("Property", "Value", "headerRow")),
                                    e.appendChild(this._createRow("Name", null !== l ? l : "unnamed")),
                                    n = 0,
                                    q = p; n < q.length; n++)
                                        t = q[n],
                                        u = f(t),
                                        v = f(m[t]),
                                        e.appendChild(this._createRow(u, v));
                                r = a.getNodeUserDataIndices(c);
                                if (0 < r.length)
                                    for (h = document.createElement("table"),
                                    h.id = "propertyTable",
                                    h.appendChild(this._createRow("User Data Index", "User Data Size", "headerRow")),
                                    x = 0,
                                    z = r; x < z.length; x++)
                                        y = z[x],
                                        B = a.getNodeUserData(c, y),
                                        u = "number" === typeof y ? "0x" + y.toString(16).toUpperCase() : "0x" + y,
                                        v = "" + B.length,
                                        h.appendChild(this._createRow(u, v));
                                if (null === e && null === h)
                                    return [2];
                                this._update("");
        ...
        (function(m) {
            ...
            var c = function() {
                ...
                a.prototype._initElements = function() {
                    ...
                    this._walkKeyIdsMap.set(e.WalkDirection.Left, "walk-key-left");
                    ...
                    $("#settings-splat-rendering-enabled").on("click", function() {
                        b._updateEnabledStyle("settings-splat-rendering-enabled", ["settings-splat-enabled-style"], ["settings-splat-rendering-size", "settings-splat-rendering-point-size-unit"], $("#settings-splat-rendering-enabled").prop("checked"))
                    });
                        ...
                        firstModelLoaded: function() {
                            return __awaiter(b, void 0, void 0, function() {
                                ...
                                return __generator(this, function(d) {
                                    switch (d.label) {
                                    case 0:
                                        return b = this._viewer.operatorManager,
                                        a = b.getOperator(e.OperatorId.KeyboardWalk),
                                        c = a.getWalkSpeed(),
                                        0 >= c ? [4, a.resetDefaultWalkSpeeds()] : [3, 2];
                                    case 1:
                                        d.sent(),
                ...
                a.prototype._updateSettings = function() {
                    ...
                    l = l.getHighlightFaceElementSelection() && l.getHighlightLineElementSelection();
                    ...
                    $("#settings-enable-face-line-selection").prop("checked", l);
                    ...
                    $("#settings-reflection-enabled").prop("checked", I);
                    ...
                    E !== $("#settings-bloom-enabled").prop("checked") && $("#settings-bloom-enabled").trigger("click");
                    ...
                    A.push(a.getPointSize().then(function(a) {
                        ...
                        b._splatRenderingEnabled && (b._splatRenderingSize = d,
                        b._splatRenderingPointSizeUnit = a);
                ...
                a.prototype._applySettings = function() {
                    ...
                    k && h ? (c.setPmiColor(k),
                    c.setPmiColorOverride(!0)) : c.setPmiColorOverride(!1);
                    ...
                    $("#settings-anti-aliasing").prop("checked") ? a.setAntiAliasingMode(e.AntiAliasingMode.SMAA) : a.setAntiAliasingMode(e.AntiAliasingMode.None);
                    ...
                    $("#settings-splat-rendering-enabled").prop("checked") ? (this._splatRenderingEnabled = !0,
                    this._splatRenderingSize = parseFloat(f.getValueAsString("#settings-splat-rendering-size")),
                    this._splatRenderingPointSizeUnit = parseInt(f.getValueAsString("#settings-splat-rendering-point-size-unit"), 10),
                    a.setPointSize(this._splatRenderingSize, this._splatRenderingPointSizeUnit)) : (this._splatRenderingEnabled = !1,
                    a.setPointSize(1, e.PointSizeUnit.ScreenPixels));
                ...
                a.prototype._applyWalkKeyText = function(b, a) {
                    a < e.KeyCode.a || a > e.KeyCode.z || (b = this._walkKeyIdsMap.get(b),
                    a = e.KeyCode[a].toUpperCase(),
                    $("#" + b).html(a))
                }
                ;
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(d) {
                            ...
                            case 0:
                                ...
                                l = parseInt(f.getValueAsString("#settings-walk-mode"), 10),
                                [4, c.setWalkMode(l)];
                            case 1:
                                return d.sent(),
                                k = parseInt(f.getValueAsString("#settings-walk-rotation"), 10),
                                h = parseFloat(f.getValueAsString("#settings-walk-speed")) * this._walkSpeedUnits,
                                m = parseFloat(f.getValueAsString("#settings-walk-elevation")) * this._walkSpeedUnits,
                                p = parseInt(f.getValueAsString("#settings-walk-view-angle"), 10),
                                n = $("#settings-mouse-look-enabled").prop("checked"),
                                q = parseInt(f.getValueAsString("#settings-mouse-look-speed"), 10),
                                t = $("#settings-bim-mode-enabled").prop("checked"),
                            ...
                            case 2:
                                ...
                                [3, 4];
                            case 3:
                                c.setRotationSpeed(k),
                                c.setWalkSpeed(h),
                                c.setElevationSpeed(m),
                                c.setViewAngle(p),
                                l === e.WalkMode.Keyboard && (a.setMouseLookEnabled(n),
                                a.setMouseLookSpeed(q)),
                                d.label = 4;
                            case 4:
                                return t ? [4, this._viewer.model.registerIfcNodes(this._viewer.model.getAbsoluteRootNode())] : [3, 7];
                            case 5:
                                return d.sent(),
                                [4, c.setBimModeEnabled(!0)];
                            case 6:
                                return d.sent(),
                                [3, 9];
                            case 7:
                ...
                a.prototype._updateWalkSpeedUnits = function(b) {
                    ...
                    b = "m";
                    .001 >= this._walkSpeedUnits ? b = "&micro;m" : 1 >= this._walkSpeedUnits ? b = "mm" : 10 >= this._walkSpeedUnits ? b = "cm" : this._walkSpeedUnits = 1E3;
                ...
                a.prototype._updateWalkSettingsHelper = function() {
                    ...
                    this._updateEnabledStyle("settings-bim-mode-enabled", [], [], a);
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(d) {
                            ...
                            case 0:
                                ...
                                a = b.getOperator(e.OperatorId.KeyboardWalk),
                                c = a.getWalkSpeed(),
                                0 !== c ? [3, 2] : [4, a.resetDefaultWalkSpeeds()];
                            case 1:
                                d.sent(),
                                d.label = 2;
                            case 2:
                                return this._updateWalkSettingsHelper(),
                                [2]
                            }
                        })
                    })
                ...
                a.prototype._applyDrawingSettings = function() {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(d) {
                            switch (d.label) {
                            case 0:
                                return b = f.colorFromRgbString(f.getValueAsString("#settings-drawing-background")),
                                a = f.colorFromRgbString(f.getValueAsString("#settings-drawing-sheet")),
                                c = f.colorFromRgbString(f.getValueAsString("#settings-drawing-sheet-shadow")),
                                l = $("#settings-drawing-background-enabled").prop("checked"),
                                [4, this._viewer.sheetManager.setBackgroundSheetEnabled(l)];
                            case 1:
                                return d.sent(),
                                [4, this._viewer.sheetManager.setSheetColors(b, a, c)];
                            case 2:
                                return d.sent(),
                                [2]
                            }
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(b) {
                            ...
                            case 4:
                                ...
                                b.label = 5;
                            case 5:
                                return x = this._viewer.floorplanManager.isActive(),
                                $("#settings-floorplan-active").prop("checked", x),
                                [2]
                            }
                        })
                    })
    ...
    (function(f) {
        var m = function() {
                ...
                $(c).on("click", ".ui-bcf-topic", function(b) {
                    return __awaiter(a, void 0, void 0, function() {
                        ...
                        return __generator(this, function(d) {
                            switch (d.label) {
                            case 0:
                                return a = jQuery(b.target),
                                c = a.closest(".viewpoint, .comment").get(0),
                                void 0 === c ? [3, 2] : [4, this._onTreeSelectItem(c.id)];
                            case 1:
                                d.sent(),
                                d.label = 2;
                            case 2:
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(k) {
                        ...
                        case 1:
                            ...
                            c.setViewpoint(h, m),
                            p = f + ".png",
                            [4, this._addSnapshot(c, p)];
                        case 2:
                            return k.sent(),
                            d.addViewpoint(f, h, p),
                            [2, d.addComment(g, l, a, f)]
                        }
                    })
                })
            }
            ...
            f.prototype._addSnapshot = function(c, a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(d) {
                        ...
                        case 1:
                            return b = d.sent(),
                            c.addSnapshot(a, e.BCFSnapshot.snapshotDataFromImage(b)),
                            [2]
                        }
                    })
                })
            ...
            f.prototype._addBcf = function(c) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        switch (g.label) {
                        case 0:
                            return a = this._viewer,
                            b = a.BCFManager,
                            d = b.createBCFData(c),
                            [4, this._addTopic(d, c)];
                        case 1:
                            return g.sent(),
                            [2, d]
                        }
                                    ...
                                    c.onload = function() {
                                        return __awaiter(f, void 0, void 0, function() {
                                            ...
                                            return __generator(this, function(b) {
                                                ...
                                                case 0:
                                                    return a = c.result,
                                                    null === a || "object" !== typeof a ? [3, 2] : [4, this._viewer.BCFManager.addBCFFromBuffer(a, d.name.split(".")[0])];
                                                case 1:
                                                    b.sent(),
                                                    b.label = 2;
                                                case 2:
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(k) {
                        ...
                        case 0:
                            ...
                            [4, e.BCFTopic.createTopic(this._viewer, c.getId(), c.getFilename(), a, b)];
                        case 1:
                            return d = k.sent(),
                            c.addTopic(d.getTopicId(), d),
                            g = this._buildTopic(c, d),
                            l = this._getBcfHtmlId(c.getId()),
                            null !== l && (f = document.getElementById(l),
                            null !== f && f.appendChild(g)),
                            [2, d]
                        }
                    })
                })
            ...
            f.prototype._initEvents = function() {
                ...
                if (null === a)
                    throw new e.CommunicatorError("container is null");
                this._events(a);
            ...
            f.prototype._buildComment = function(c, a) {
                ...
                null !== g && (g = c.getMarkup().getViewpoints().get(g),
                void 0 !== g && (g = g.getSnapshotFilename(),
                null !== g && (g = c.getSnapshot(g),
                null !== g && d.appendChild(this._buildImage(g.getUrl())))));
                g = this._getId();
                this._commentGuidMap.set(a.getId(), g);
            ...
            f.prototype._addComment = function(c, a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(l) {
                        ...
                        case 0:
                            return b = this._viewer.markupManager.getActiveMarkupView(),
                            [4, this._addBCFComment(c, a, b)];
                        case 1:
                            return d = l.sent(),
                            g = this._buildComment(c, d),
                            e = this._topicCommentsGuidMap.get(c.getTopicId()),
                            void 0 !== e && (f = document.getElementById(e),
                            null !== f && f.appendChild(g)),
                            [2, d]
                        }
                    })
            ...
            f.prototype._deleteComment = function(c, a, b) {
                ...
                null !== b && null !== b.parentElement && (b.parentElement.removeChild(b),
                c.getMarkup().deleteComment(a.getId()),
                this._refreshScroll())
            }
            ;
            f.prototype._setCommentText = function(c, a) {
                var b = this._commentGuidMap.get(c.getId());
                void 0 !== b && (b = document.getElementById(b),
                null !== b && (c.setText(a),
                b.textContent = a,
                this._refreshScroll()))
            }
                    ...
                    return __awaiter(a, void 0, void 0, function() {
                        ...
                        return __generator(this, function(b) {
                            ...
                            case 0:
                                return a = d.value,
                                d.value = "",
                                0 < a.length ? [4, this._addComment(c, a)] : [3, 2];
                            case 1:
                                b.sent(),
                                b.label = 2;
                            case 2:
            ...
            f.prototype._buildTopic = function(c, a) {
                ...
                var e = a.getMarkup()
                  ...
                  , m = e.getTopicIndex();
                null !== m && (m = "<b>Index</b>: " + m,
                h.appendChild(this._buildDiv(this._getId(), m, "index")));
                m = this._getId();
                ...
                this._viewpointIdMap.set(h, f),
                h = this._buildDiv(h, "", "viewpoint"),
                f = a.getSnapshot(f.getFilename()),
                null !== f && h.appendChild(this._buildImage(f.getUrl())),
                d.appendChild(h));
            ...
            f.prototype._removeBCF = function(c) {
                ...
                null !== c && (this._bcfIdMap.delete(c),
                $("#" + c).remove(),
                $("#" + this._getSelectId(c)).remove(),
                c = this._bcfDataList.value,
                0 < c.length && this._showBCFData(c))
            }
            ;
            f.prototype._getViewpointFromComment = function(c, a) {
                a = a.getViewpointGuid();
                return null !== a && (a = c.getMarkup().getViewpoints().get(a),
                void 0 !== a && (a = a.getViewpointFilename(),
                null !== a)) ? c.getViewpoint(a) : null
            }
            ;
            ...
            f.prototype._onTreeSelectItem = function(c) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(b) {
                        switch (b.label) {
                        case 0:
                            return a = this._getViewpoint(c),
                            null === a ? [3, 2] : [4, a.activate()];
                        case 1:
                            b.sent(),
                            b.label = 2;
                        case 2:
    ...
    (function(f) {
        var m = function(h) {
            ...
            c.prototype._createCadViewNodes = function(a) {
                var b = this;
                if (0 !== a.size) {
                    this._viewFolderCreated || (this._tree.appendTopLevelElement("Views", this._internalId, "viewfolder", !0),
                    this._viewFolderCreated = !0);
                    ...
                    a.forEach(function(a, c) {
                        b._cadViewIds.has(c) || !e(c) || d.isAnnotationView(c) || (b._cadViewIds.add(c),
                        b._tree.addChild(a, b._cadViewId(c), b._internalId, "view", !1, f.Desktop.Tree.CadView))
                    });
                    a.forEach(function(a, c) {
                        !b._cadViewIds.has(c) && e(c) && d.isAnnotationView(c) && null === document.getElementById(b._internalId + b._annotationViewsString) && b._tree.addChild(b._annotationViewsLabel, b._internalId + b._annotationViewsString, b._internalId, "viewfolder", !0, f.Desktop.Tree.CadView)
                    });
                    a.forEach(function(a, c) {
                        !b._cadViewIds.has(c) && e(c) && d.isAnnotationView(c) && (b._cadViewIds.add(c),
                        a = a.split("# Annotation View")[0],
                        b._tree.addChild(a, b._cadViewId(c), b._internalId + b._annotationViewsString, "view", !1, f.Desktop.Tree.CadView))
                    })
                }
            }
            ;
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        ...
                        case 0:
                            ...
                            if (b[0] !== this._internalId)
                                return [3, 3];
                            d = this._viewer.operatorManager.getOperator(e.OperatorId.Handle);
                            return [4, d.removeHandles()];
                        case 1:
                            return g.sent(),
                            [4, this._viewer.model.activateCadView(parseInt(b[1], 10))];
                        case 2:
                            g.sent(),
                            g.label = 3;
                        case 3:
                            return c = document.getElementById(a),
                            null !== c && ("LI" === c.tagName && a !== this._internalId && a !== this._internalId + this._annotationViewsString ? (c.classList.add("selected"),
                            this._lastSelectedhtmlId = a) : c.classList.remove("selected")),
                            [2]
                        }
                    })
                })
            ...
            c.prototype._onNewModel = function() {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(b) {
                        switch (b.label) {
                        case 0:
                            return a = this._viewer.model,
                            [4, a.cadConfigurationsEnabled()];
                        case 1:
                            if (!b.sent())
                                return [3, 4];
            ...
            c.prototype._onTreeSelectItem = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(d) {
                        switch (d.label) {
                        case 0:
                            return b = this._splitHtmlId(a),
                            this._internalId !== b[0] ? [3, 3] : [4, this._viewer.operatorManager.getOperator(e.OperatorId.Handle).removeHandles()];
                        case 1:
                            return d.sent(),
            ...
            c.prototype._setFilter = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        ...
                        case 3:
                            return g.sent(),
                            d.isInclusive ? [4, b.setNodesVisibility([b.getAbsoluteRootNode()], !1)] : [3, 6];
                        case 4:
                            return g.sent(),
                            [4, b.setNodesVisibility(c, !0)];
                        case 5:
                            return g.sent(),
                            [3, 8];
                        case 6:
        ...
        var m = function(h) {
                    ...
                    selectionArray: function(b) {
                        if (0 !== a._layerNames.length) {
                            ...
                            for (var d = 0; d < b.length; d++) {
                                ...
                                if (null !== c) {
                                    for (var e = 0, f = a._viewer.model.getNodeChildren(c); e < f.length; e++)
                                        a._expandPart(f[e]);
                                    a._expandPart(c)
                                }
                            }
            ...
            c.prototype._onNewModel = function() {
                ...
                this._layerNames.filter(function(d) {
                    ...
                    return null !== e && 0 < e.length ? (a._tree.appendTopLevelElement(d, g, "assembly", !0, !1),
                    !0) : !1
                });
            ...
            c.prototype._loadNodeChildren = function(a) {
                ...
                null !== b && (a = c.getLayerId(b),
                null !== a && (b = this._viewer.model.getNodesFromLayerName(b, !0),
                null !== b && (b.length < this._maxNodeChildrenSize ? this._addLayerParts(a, b) : this._addLayerPartContainers(a, b))))
            }
            ;
            c.prototype._addLayerParts = function(a, b) {
                ...
                b.forEach(function(b) {
                    var k = g.getNodeType(b)
                      , h = g.getModelFileTypeFromNode(b);
                    l || h === e.FileType.Dwg || k !== e.NodeType.BodyInstance || (k = g.getNodeParent(b),
                    null !== k && (b = k));
                    k = g.getNodeName(b);
                    h = c._createPartId(b);
                    c._layerPartIdMap.set(h, b);
                    c._idLayerPartMap.set(b, h);
                    d._layerParts.has(b) || (d._layerParts.add(b),
                    d._tree.addChild(k, h, a, "assembly", !1, f.Desktop.Tree.Layers))
                })
            }
            ;
            c.prototype._addLayerPartContainers = function(a, b) {
                for (var d = Math.ceil(b.length / this._maxNodeChildrenSize), g = [], e = 0; e < d; ++e) {
                    var k = e * this._maxNodeChildrenSize
                      , h = Math.min(k + this._maxNodeChildrenSize, b.length)
                      , m = "Child Nodes " + k + " - " + h
            ...
            c.prototype._expandPart = function(a) {
                if (this._viewer.model.isNodeLoaded(a)) {
                    ...
                    if (null !== b) {
                        ...
                        if (null !== d && (b = c.getLayerId(d),
                        null !== b)) {
                            var g = this._viewer.model.getNodesFromLayerName(d, !0);
                            null !== g && (d = null,
                            g.length >= this._maxNodeChildrenSize && (a = g.indexOf(a),
                            a = Math.floor(a / this._maxNodeChildrenSize),
                            g = c._layerContainersMap.get(b),
                            void 0 !== g && a < g.length && (d = g[a])),
                            this._tree.expandChildren(b),
                            null !== d && this._tree.expandChildren(d))
                        }
                    }
                }
            }
            ...
            c._createPartId = function(a) {
                return "" + c.layerPartPrefix + c.separator + a
            }
            ;
    ...
    (function(f) {
        var m = function(h) {
            ...
            c.prototype._initEvents = function() {
                ...
                this._viewer.setCallbacks({
                    ...
                    sheetActivated: function(b) {
                        b !== a._currentSheetId && (a._currentSheetId = b,
            ...
            c.prototype._onSubtreeLoaded = function(a) {
                for (var b = this._viewer.model, d = 0; d < a.length; d++) {
                    ...
                    if (!b.getOutOfHierarchy(c)) {
                        ...
                        if (null === e)
                            console.assert(null !== this._lastModelRoot),
                            this._lastModelRoot = this._tree._insertNodeAfter(b.getNodeName(c), this._partId(c), "modelroot", this._lastModelRoot, !0);
                        else {
                            var k = e;
                            do {
                ...
                this._startedWithoutModelStructure && (a = this._tree.getRoot(),
                null !== a.firstChild && a.removeChild(a.firstChild),
                a = this._tree.getPartVisibilityRoot(),
                null !== a.firstChild && a.removeChild(a.firstChild))
            }
            ;
            c.prototype._onSubtreeDeleted = function(a) {
                for (var b = 0; b < a.length; b++)
                    this._tree.deleteNode(this._partId(a[b]))
            }
            ;
            c.prototype._buildTreePathForNode = function(a) {
                for (var b = this._viewer.model, d = [], c = b.getNodeParent(a); null !== c && (!this._viewer.sheetManager.isDrawingSheetActive() || null === this._currentSheetId || c !== this._currentSheetId && a !== this._currentSheetId); )
                    d.push(c),
                    c = b.getNodeParent(c);
                d.reverse();
                return d
            ...
            c.prototype._expandCorrectContainerForNodeId = function(a) {
                var b = this._viewer.model
                  , d = b.getNodeParent(a);
                null !== d && (a = b.getNodeChildren(d).indexOf(a),
                0 <= a && this._tree.expandChildren(this._containerId(d, Math.floor(a / this._maxNodeChildrenSize))))
            }
            ;
            ...
            c.prototype._createContainerNodes = function(a, b) {
                for (var d = 1, c = this._maxNodeChildrenSize, e = 0; !(this._tree.addChild("Child Nodes " + d + " - " + Math.min(c, b.length), this._containerId(a, e), this._partId(a), "container", !0, f.Desktop.Tree.Model),
                d += this._maxNodeChildrenSize,
                ++e,
                c >= b.length); )
                    c += this._maxNodeChildrenSize
            }
            ;
            c.prototype._loadAssemblyNodeChildren = function(a) {
                var b = this._viewer.model.getNodeChildren(a);
                b.length > this._maxNodeChildrenSize ? this._createContainerNodes(a, b) : (a = this._partId(a),
                ...
                for (var d = this, c = this._viewer.model, l = null, k = 0; k < a.length; k++) {
                    ...
                    case e.NodeType.Pmi:
                        if (null === l) {
                            ...
                            null !== t && (l = this._tree.addChild("PMI", this._pmiFolderId(t), b, "modelroot", !0, f.Desktop.Tree.Model, !0, !0))
                        }
                        null !== l && (p = l.id,
                        n = "assembly");
                        break;
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        ...
                        case 0:
                            ...
                            return [3, 5];
                        case 1:
                            return this._viewer.selectPart(parseInt(e[1], 10), b),
                            [3, 5];
                        case 2:
                        ...
                        case 3:
                            ...
                            [3, 5];
                        case 4:
                            return this._onContainerClick(e[1]),
                            [3, 5];
                        case 5:
                            return [2]
                        }
        ...
        var m = function(h) {
                ...
                this._tree.registerCallback("clickItemButton", function(b) {
                    return __awaiter(a, void 0, void 0, function() {
                        return __generator(this, function(a) {
                            switch (a.label) {
                            case 0:
                                return [4, this._onSelectRelationships(b)];
                            case 1:
                                return a.sent(),
                                [2]
                            }
            ...
            c.prototype._onTreeSelectItem = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(g) {
                        b = 0;
                        for (d = a; b < d.length; b++)
                            c = d[b],
                            e = c.getSelection().getNodeId(),
                            null === e ? this._tree.selectItem(null, !1) : (f = this._viewer.model.getBimIdFromNode(e),
                            null !== f && (this._currentNodeId = e,
                            this._currentBimNodeId = f,
                            this._update()));
                        return [2]
                    })
                })
            ...
            c.prototype._translateStringTypeToRelationshipType = function(a) {
                ...
                case "ConnectsPathElements":
                    a = e.RelationshipType.ConnectsPathElements;
                    break;
                default:
            ...
            c.prototype._addRelationships = function(a, b) {
                ...
                for (var d = this._viewer.model.getBimIdConnectedElements(this._currentNodeId, this._currentBimNodeId, b), g = 0, e = d.relatings; g < e.length; g++) {
                    ...
                    k = c._createIdNode(k);
                    h = this._viewer.model.getBimInfoFromBimId(this._currentNodeId, h);
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(f) {
                        ...
                        if (null === b)
                            return [2];
                        d = this._splitHtmlId(a);
                        0 < d.length && (g = this._splitHtmlIdParts(d[0], c.separator),
                        g[0] === c.RelationshipPartPrefix && (e = this._viewer.model.getNodeIdFromBimId(this._currentNodeId, g[1]),
                        null !== e && (this._viewer.model.resetModelHighlight(),
            ...
            c.prototype._onSelectRelationships = function(a) {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(f) {
                        b = this._splitHtmlId(a);
                        0 < b.length && (d = this._splitHtmlIdParts(b[0], c.separator),
                        d[0] === c.RelationshipPartPrefix && (g = this._viewer.model.getNodeIdFromBimId(this._currentNodeId, d[1]),
                        this._viewer.selectPart(g, e.SelectionMode.Set)));
                        return [2]
                    })
                })
            }
        ...
        var m = function(h) {
            ...
            c.prototype._onNewModel = function() {
                ...
                if (this._viewer.model.isDrawing()) {
                    for (var a = this._viewer.model, b = 0, d = this._viewer.sheetManager.getSheetIds(); b < d.length; b++) {
                        var c = d[b]
                          , e = a.getNodeName(c);
                        c = this._sheetTreeId(c);
                        this._tree.appendTopLevelElement(e, c, "sheet", !1)
                    }
                    0 < this._viewer.sheetManager.get3DNodes().length && (this._tree.appendTopLevelElement("3D Model", this._3dSheetId, "sheet", !1, !1, !1),
            ...
            ;
            c.prototype._onSheetDeactivated = function() {
                ...
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(c) {
                        ...
                        case 1:
                            ...
                            return [4, this._viewer.setViewOrientation(e.ViewOrientation.Front, 0)];
                        case 2:
                            c.sent(),
                            c.label = 3;
                        case 3:
        ...
        (function(m) {
            var h = function() {
              ...
              , c = function() {
                ...
                a.prototype._clearStyles = function() {
                    ...
                    for (b = this._partialHiddenParentIds; a < b.length; a++)
                        c = b[a],
                        this._removeVisibilityHiddenClass(c, "partialHidden");
                ...
                a.prototype._applyStyles = function() {
                    ...
                    for (b = this._partialHiddenParentIds; a < b.length; a++)
                        c = b[a],
                        this._addVisibilityHiddenClass(c, "partialHidden")
                }
                ;
                a.prototype.updateModelTreeVisibilityState = function() {
                    if (this._assemblyTreeReadyOccurred) {
                        ...
                        for (var a = this._viewer.model, b = [a.getAbsoluteRootNode()], c = 0; c < b.length; c++) {
                            ...
                            if (h === e.BranchVisibility.Hidden)
                                this._fullHiddenParentIds.push(f);
                            else if (h === e.BranchVisibility.Mixed)
                                for (this._partialHiddenParentIds.push(f),
                                h = 0,
                                f = a.getNodeChildren(f); h < f.length; h++)
                                    b.push(f[h])
                        }
                        this._applyStyles()
                    }
            ...
            var a = function() {
                ...
                a.prototype.registerCallback = function(a, b) {
                    this._callbacks.has(a) || this._callbacks.set(a, []);
                ...
                a.prototype._getTaggedId = function(a, b, c) {
                    return null !== c && "Annotation Views" === c && b === f.Desktop.Tree.CadView ? new h("Annotation Views") : this._parseTaggedId(a)
                }
                ;
                a.prototype.addChild = function(a, b, c, e, h, m, p, n) {
                    ...
                    if (m === f.Desktop.Tree.Model && "container" !== e && null !== d.nodeId) {
                        if (this._loadedNodes.has(d.nodeId) && !n)
                            return null;
                    ...
                    var g = c.children("ul")
                      , l = n = !1;
                    null !== d.nodeId && (n = this._futureHighlightIds.has(d.nodeId),
                    l = this._futureMixedIds.has(d.nodeId),
                    n && this._futureHighlightIds.delete(d.nodeId),
                    l && this._futureMixedIds.delete(d.nodeId));
                    a = this._buildNode(a, b, e, h, n, l, p, m === f.Desktop.Tree.Relationships);
                    0 === g.length ? (e = document.createElement("ul"),
                    e.classList.add("ui-modeltree-children"),
                    c.append(e),
                    e.appendChild(a)) : g.get(0).appendChild(a);
                    n && (b = this._getListItem(b),
                    null !== b && this._selectedPartItems.push(b));
                ...
                a.prototype._addVisibilityToggleChild = function(a, b, c) {
                    ...
                    var d = b.children("ul");
                    0 === d.length ? (d = document.createElement("ul"),
                    d.classList.add("ui-modeltree-visibility-children"),
                    b.append(d)) : d = d.get(0);
                ...
                a.prototype._buildPartVisibilityNode = function(a, b) {
                    ...
                    if ("measurement" !== b) {
                        ...
                        if (a === e.NodeType.Pmi || a === e.NodeType.PmiBody)
                ...
                a.prototype.updateSelection = function(a) {
                    ...
                    a = a.map(function(a) {
                        return a instanceof e.Event.NodeSelectionEvent && (a = a.getSelection(),
                        !a.isNodeSelection()) ? (console.assert(!1),
                        e.InvalidNodeId) : a.getNodeId()
                    });
                ...
                a.prototype.collapseAllChildren = function(a) {
                    this._freezeExpansion || ($("#" + a + " .ui-modeltree-children").hide(),
                    $("#" + a + " .ui-modeltree-visibility-children").hide(),
                ...
                a.prototype._expandChildren = function(a, b) {
                    ...
                    if (!this._freezeExpansion || b)
                        0 < d.length && (d.children(".ui-modeltree-children").show(),
                        d.children(".ui-modeltree-container").children(".ui-modeltree-expandNode").addClass("expanded")),
                ...
                a.prototype.preloadChildrenIfNecessary = function(a) {
                    null === a || this._childrenLoaded.has(a) || (this._triggerCallback("loadChildren", a),
                    this._childrenLoaded.add(a))
                }
                ;
                ...
                a.prototype._doUnfreezeSelection = function(a) {
                    for (var b = 0; b < a.length; b++) {
                        ...
                        null === e || e.hasClass("selected") ? null === e && this._futureHighlightIds.add(c) : (e.addClass("selected"),
                        this._selectedPartItems.push(e));
                        null !== d && (e = f.LayersTree.getLayerPartId(d),
                        null !== e && (e = this._getListItem(e),
                        null === e || e.hasClass("selected") ? null === e && this._futureHighlightIds.add(d) : (e.addClass("selected"),
                        this._selectedPartItems.push(e))),
                        d = this._getListItem(f.TypesTree.getComponentPartId(d)),
                        null === d || d.hasClass("selected") || (d.addClass("selected"),
                        this._selectedPartItems.push(d)));
                        c = this._getListItem(f.TypesTree.getComponentPartId(c));
                        null === c || c.hasClass("selected") || (c.addClass("selected"),
                        this._selectedPartItems.push(c))
                    }
                }
                ;
                a.prototype._doSelection = function(a, b) {
                    ...
                    if (null !== a) {
                        ...
                        if (g || h || m) {
                            ...
                            if (0 === a.lastIndexOf("container", 0) || d[0] === f.LayersTree.layerPartContainerPrefix)
                                return;
                            this._updateNonSelectionHighlight(n)
                        }
                        b && (this._lastItemId = a,
                        q = q && 1 === this._selectedPartItems.length,
                        this._triggerCallback("selectItem", a, "undefined" !== typeof key && (key.ctrl || key.command) || q ? e.SelectionMode.Toggle : e.SelectionMode.Set));
                ...
                a.prototype._scrollToItem = function(b) {
                    ...
                    this._scrollTimer.set(a._ScrollToItemDelayMs, function() {
                        ...
                        void 0 !== a && void 0 !== d && (a = a.top,
                        6 > a || a > d) && (c._scrollTimer.clear(),
                        c._treeScroll && (c._treeScroll.refresh(),
                        c._treeScroll.scrollToElement(b.get(0), f.DefaultUiTransitionDuration, !0, !0)))
                    })
                }
                ;
                ...
                a.prototype._parseNodeId = function(a) {
                    ...
                    if (2 > a.length || "measurement" === a[0] || "markupview" === a[0])
                        return null;
                    a = a[a.length - 1];
                    return void 0 === a || (a = parseInt(a, 10),
                    isNaN(a)) ? null : a
                }
                ;
                ...
                a.prototype._updateLayerTreeSelectionHighlight = function(a) {
                    ...
                    c = 0;
                    for (d = this._selectedLayers; c < d.length; c++)
                        e = d[c],
                        $("#" + f.LayersTree.getLayerId(e)).addClass("selected"),
                        $("#" + f.LayersTree.getLayerId(e)).removeClass("mixed");
                    for (e = 0; e < a.length; e++)
                        $("#" + f.LayersTree.getLayerPartId(a[e])).addClass("selected")
                }
                ;
                a.prototype._addMixedTypeClass = function(a) {
                    a = this._viewer.model.getNodeGenericType(a);
                    return null === a || this._mixedTypes.has(a) ? !1 : ($("#" + f.TypesTree.getGenericTypeId(a)).addClass("mixed"),
                    this._mixedTypes.add(a),
                    !0)
                }
                ;
                a.prototype._updateTypesTreeSelectionHighlight = function() {
                    ...
                    c = 0;
                    for (a = this._futureMixedTypesIds; c < a.length; c++)
                        b = a[c],
                        this._addMixedTypeClass(b) || (b = this._viewer.model.getNodeParent(b),
                        null !== b && this._addMixedTypeClass(b));
                    this._selectedTypes = this._viewer.selectionManager.getSelectedTypes();
                    a = 0;
                    for (b = this._selectedTypes; a < b.length; a++)
                        c = b[a],
                        c = $("#" + f.TypesTree.getGenericTypeId(c)),
                        c.addClass("selected"),
                        c.removeClass("mixed")
                }
                ;
                a.prototype._updateTreeSelectionHighlight = function(a) {
                    ...
                    e.Util.filterInPlace(this._selectedPartItems, function(c) {
                        ...
                        if (void 0 !== c) {
                            ...
                            if (null === c)
                                return !1;
                            if (0 > a.indexOf(c))
                                return $("#part" + f.ViewTree.separator + c).removeClass("selected"),
                                $("#typespart" + f.ViewTree.separator + c).removeClass("selected"),
                                (c = f.LayersTree.getLayerPartId(c)) && $("#" + c).removeClass("selected"),
                                !1
                        }
                        return !0
                    });
                    for (c = 0; c < a.length; c++)
                        h = a[c],
                        this._updateParentIdList(h),
                        this._updateMixedLayers(h),
                        this._updateMixedTypes(h);
                    c = 0;
                ...
                a.prototype._updateParentIdList = function(a) {
                    var b = this._viewer.model;
                    if (b.isNodeLoaded(a))
                        for (a = b.getNodeParent(a); null !== a && -1 === this._selectedItemsParentIds.indexOf(a); )
                            this._selectedItemsParentIds.push(a),
                            a = b.getNodeParent(a)
                }
                ;
                a.prototype._updateMixedLayers = function(a) {
                    ...
                    }, d = 0, e = this._viewer.model.getNodeChildren(a); d < e.length; d++)
                        c(e[d]);
                    c(a)
                }
                ;
                ...
                a.prototype._insertNodeAfter = function(a, b, c, f, h) {
                    ...
                    if (null === f.parentNode)
                        throw new e.CommunicatorError("element.parentNode is null");
                ...
                ;
                a.prototype.clear = function() {
                    for (; this._listRoot.firstChild; )
                        this._listRoot.removeChild(this._listRoot.firstChild);
                    for (; this._partVisibilityRoot.firstChild; )
                ...
                a.prototype._processPartVisibilityClick = function(a) {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(c) {
                            switch (c.label) {
                            case 0:
                                return b = this._parseNodeId(a),
                                null === b ? [3, 2] : [4, this._processPartVisibility(b)];
                            case 1:
                                c.sent(),
                                c.label = 2;
                            case 2:
                ...
                a.prototype._processPartVisibility = function(a) {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(f) {
                            switch (f.label) {
                            case 0:
                                return b = this._viewer.model,
                                c = b.getNodeVisibility(a),
                                d = b.hasEffectiveGenericType(a, e.StaticGenericType.IfcSpace),
                                [4, b.setNodesVisibility([a], !c, d ? !1 : null)];
                            case 1:
                                return f.sent(),
                                [2]
                            }
                ...
                a.prototype._processTypesVisibilityClick = function(a) {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(c) {
                            switch (c.label) {
                            case 0:
                                return b = a.split(this._separator).pop(),
                                void 0 === b ? [2] : [4, this._processTypesVisibility(b)];
                            case 1:
                                return c.sent(),
                                [2]
                            }
                ...
                a.prototype._processTypesPartVisibilityClick = function(a) {
                    return __awaiter(this, void 0, void 0, function() {
                        ...
                        return __generator(this, function(c) {
                            ...
                            case 0:
                                return b = this._parseNodeId(a),
                                null === b ? [2] : [4, this._processTypesPartVisibility(b)];
                            case 1:
                                return c.sent(),
                                [2]
                            }
                ...
                a.prototype.updateTypesVisibilityIcons = function() {
                    ...
                    a.getGenericTypeIdMap().forEach(function(b, c) {
                        ...
                        b.forEach(function(b) {
                            ...
                            a.getNodeVisibility(b) ? e = !0 : (d = !0,
                            c.addClass("partHidden"))
                        });
                    ...
                    this._viewer.model.getUniqueLayerNames().forEach(function(b) {
                        ...
                        if (null !== c) {
                            for (var d = !1, e = !1, g = 0; g < c.length; ++g) {
                                ...
                                null !== h && (h = $("#visibility" + f.ViewTree.separator + f.LayersTree.getLayerPartId(h)),
                                h.removeClass("partHidden"),
                                a._viewer.model.getNodeVisibility(c[g]) ? e = !0 : (d = !0,
                                h.addClass("partHidden")))
                            }
                ...
                a.prototype.updateMeasurementVisibilityIcons = function() {
                    for (var a = this._viewer.measureManager.getAllMeasurements(), b = 0, c = 0; c < a.length; c++) {
                        ...
                        h ? e.removeClass("partHidden") : (b++,
                        e.addClass("partHidden"))
                    }
                    c = $("#visibility" + f.ViewTree.separator + "measurementitems");
                    b === a.length ? (c.removeClass("partialHidden"),
                    c.addClass("partHidden")) : 0 < b && b < a.length ? (c.removeClass("partHidden"),
                    c.addClass("partialHidden")) : (c.removeClass("partialHidden"),
                    c.removeClass("partHidden"));
        ...
        var m = function() {
          ...
          , h = function(c) {
            ...
            a.prototype._onTreeSelectItem = function(a, c) {
                ...
                null !== document.getElementById(a) && (a = this._splitHtmlId(a)[1],
                "IFC" === a.substr(0, 3) ? this._selectIfcComponent(a, c) : this._viewer.selectPart(parseInt(a, 10), c))
            }
            ;
            ...
            a.prototype._loadContainerChildren = function(a) {
                ...
                if (void 0 !== b) {
                    ...
                    if (void 0 !== b) {
                        ...
                        c = 0;
                        for (b = e.Util.setToArray(b).slice(f, h); c < b.length; c++)
                            this._addChildPart(b[c], a)
                    }
                }
            }
            ;
            ...
            a.prototype._createContainerNodes = function(b, c) {
                ...
                if (void 0 === d)
                    console.assert(!1, "Tried to create a container for nodes of a non-existent GenericType");
                else
            ...
            a.getContainerId = function(a) {
                return "container" + f.ModelTree.separator + a
            }
            ;
            return a
        }(f.ViewTree);
